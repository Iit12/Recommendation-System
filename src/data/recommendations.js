export const RECOMMENDATIONS = {
  'iphone-16': {
    ...
    reasoning: "Today's price of ₹68,999 is 3.4% below the 30-day moving average (₹71,450) and within 1.5% of the all-time lowest price recorded on Flipkart.",
    signals: [
  ...
  'sony-wh-1000xm5': {
    ...
    reasoning: "Price dropped by 29% from MSRP down to ₹24,990 on Amazon, which is 7.1% below its 30-day average. This is one of the lowest price points in 2026.",
    signals: [
  ...
  'macbook-air-m4': {
    ...
    reasoning: "The current price of ₹94,990 is 2.3% higher than the 30-day average (₹92,800). Historical data suggests a periodic sale event drops this model to ~₹91,990.",
    signals: [
  ...
  'samsung-galaxy-s25': {
    ...
    reasoning: "Price has steadily softened across Flipkart and Amazon down to ₹74,999. It represents a 12% discount off MRP with zero shipping fees.",
    signals: [
  ...
  'airpods-pro-2': {
    ...
    reasoning: "AirPods Pro 2 rarely dips below ₹19,000 outside major annual sales. Current ₹18,999 price on Amazon is 10.4% lower than the 30-day average.",
    signals: [
  ...
  'boat-nirvana-ion': {
    ...
    reasoning: "At ₹1,699 with 78% discount, this product is in its sweet spot. Quick-commerce options are also stocked for instant 11-min delivery.",
    signals: [
